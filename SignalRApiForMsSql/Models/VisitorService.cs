...
namespace SignalRApiForMsSql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "select tarih,[1],[2],[3],[4],[5],[6] from (select[City],CityVisitCount,Cast([VisitDate] as Date) as tarih from Visitors) as VisitTable \r\nPivot (Sum(CityVisitCount) for City in([1],[2],[3],[4],[5],[6])) as pivotTable order by tarih asc";
